    ...
    <section id="services" className={s.section}>
      <div className={`${s.wrapper} wrapper`}>
        ...
        <p className={s.description}>
          ...
          запит. Для консультації та розрахунку натисніть на кнопку нижче
          вказані орієнтовно. Точна вартість вашого проєкту стане відома після
          розрахунку обсягу роботи, який буде потрібен під ваш конкретний запит.
          Для консультації та розрахунку заповніть форму нижче
        </p>
      </div>
    </section>
  );
